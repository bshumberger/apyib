...
def test_cisd_analytic_aat_h2o2_STO_3G_canonical():
    ...
    aat = analytic_derivative.compute_CISD_AATs(normalization='full', orbitals='canonical')
    print(aat)
...
def test_cisd_analytic_aat_h2o2_STO_3G_noncanonical():
    ...
    # Compute analytic AATs using apyib.
    analytic_derivative = apyib.analytic_aats.analytic_derivative(parameters)
    aat = analytic_derivative.compute_CISD_AATs(normalization='full', orbitals='non-canonical')
    print(aat)
